# This file contains AdaAtt, TopDown model
...
class AttModel(nn.Module):
    ...
    def forward(self, fc_feats, att_feats, seq):
        ...
        for i in range(seq.size(1) - 1):
            ...
            alpha, output, state = self.core(xt, fc_feats, att_feats, p_att_feats, state)
...
class AdaAttCore(nn.Module):
    ...
    def forward(self, xt, fc_feats, att_feats, p_att_feats, state):
        ...
        alpha, atten_out = self.attention(h_out, p_out, att_feats, p_att_feats)
        return alpha, atten_out, state
...
class TopDownCore(nn.Module):
    def __init__(self, opt, use_maxout=False):
        ...
        self.drop_prob_lm = opt.drop_prob_lm
        #======  TODO  =================================================================#
        # Set up two LSTMs for attention LSTM and language LSTM
        # Hint: self.att_lstm = nn.LSTMCell(...)
        #           input: hidden of Language LSTM(prev_h), mean-pooled image feature(fc_feats), word embedding(xt)
        #           hidden size: rnn_size
        #       self.lang_lstm = nn.LSTMCell(...)
        #           input: attention features, hidden of Topdown Attention LSTM
        #           hidden size: rnn_size
    ...
    def forward(self, xt, fc_feats, att_feats, p_att_feats, state):
        #======  TODO  =================================================================#
        # Implement TopDown Attention model
        # Hint: state = ([h_att, h_lang], [c_att, c_lang]), h_att = state[0][0]
        #       torch.stack()           concatenates sequence of tensors
        # http://pytorch.org/docs/master/torch.html?#torch.stack
